...
@NgModule({
  ...
  imports: [
    ...
    // * importar arquivo app.routes e preloadingStrategy pre-carrega os modulos em background
  ...
  providers: [
    ...
    // ** habilita a compatibilidade com AngularJS e coloca o # na url para que
    // servidor Http não processe nada após o # e pare com os erros 404.
